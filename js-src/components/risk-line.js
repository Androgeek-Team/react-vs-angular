  ...
  render: function() {
    return React.DOM.tr({
      ...
      children: [
        ...
        React.DOM.td({className: "text-center"}, this.props.risk.probability * this.props.risk.impact),

        // Areas
        React.DOM.td({className: "impact-area text-center"}, (this.props.risk.areas.indexOf(0) > -1 ? "X" : "")),
        React.DOM.td({className: "impact-area text-center"}, (this.props.risk.areas.indexOf(1) > -1 ? "X" : "")),
        React.DOM.td({className: "impact-area text-center"}, (this.props.risk.areas.indexOf(2) > -1 ? "X" : "")),

        React.DOM.td({}, this.props.risk.plan),

        React.DOM.td({
          children: RiskStatus({status: this.props.risk.status})
        }),
        React.DOM.td({}, "[action]")
      ]
    });
